...
import srimadhipdf from "../components/assets/logos/newsletters/SriMadh-&-Sri-Veera-Anjani-Putra-Rice-Mills-Proposal-by-Magsmen.pdf"
...
export default function  SriVeeraAnjaniPutraRiceMill() {
 ...
 // Authentication / Registration state
  ...
  const handleLogin = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // 👇 OPEN PDF
    window.open(srimadhipdf, '_blank');
