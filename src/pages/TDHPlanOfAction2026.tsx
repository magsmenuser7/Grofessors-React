          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white/5 border border-white/10 p-10 rounded-[40px] flex flex-col justify-center relative overflow-hidden group">
              <div className="flex items-center gap-4 mb-6">
                 ...
                 <h3 className="text-2xl font-black tracking-tight">Vendor & Workflow Optimization</h3>
              </div>
              <p className="text-gray-400 leading-relaxed mb-6 text-sm">
                Streamlining vendor communication to ensure brand values are effectively translated into every creative asset. Clear workflow approvals will ensure milestones are identified and reached with cohesive brand impact.
              </p>
            ...
            <div className="bg-white/5 border border-white/10 p-10 rounded-[40px] flex flex-col items-center justify-center text-center group hover:bg-white/10 transition-colors">
              ...
              <p className="text-xs text-gray-500 leading-relaxed max-w-[200px]">
                Rigorous checks on regulatory standards and regional compliance for all new market entries.
              </p>
            </div>
          </div>
        </main>
