...
const ComingSoon: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#F7F6F5] to-[#EDECEA] text-center px-6 pt-32">
      {/* Logo / Icon */}
      <motion.div
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className="mb-8 flex items-center justify-center w-20 h-20 bg-[#F15A29]/10 rounded-2xl"
      >
      ...
      <motion.h1
        ...
        className="text-4xl md:text-6xl font-bold text-[#5A514F] mb-6 leading-tight"
      >
         Coming <span className="text-[#F15A29]">Soon</span>
         {/* 🚀 */}
      </motion.h1>
      ...
      <motion.p
        ...
        className="text-lg md:text-xl text-[#6C6765] max-w-2xl mx-auto mb-10 leading-relaxed"
      >
        We’re crafting something exciting!  
        Stay tuned while we prepare to launch this experience.
      </motion.p>
      ...
      <motion.div
        ...
        className="flex items-center space-x-3 mb-10 bg-white px-6 py-3 rounded-full shadow-md border border-[#E0DED9]"
      >
        <Clock className="w-5 h-5 text-[#F15A29]" />
        <span className="text-[#5A514F] font-medium">
      ...
      >
        <input
          ...
          className="flex-1 px-4 py-3 rounded-lg border border-[#6C6765]/30 focus:outline-none focus:border-[#F15A29] transition-colors"
        />
        <button className="px-6 py-3 bg-[#F15A29] text-white font-semibold rounded-lg hover:bg-[#d84d20] transition-all duration-300 flex items-center justify-center space-x-2">
      ...
      <motion.p
        ...
        className="mt-16 text-sm text-[#6C6765]"
      >
        {/* © {new Date().getFullYear()} Grofessors. All rights reserved. */}
      </motion.p>
    </div>
  );
};
